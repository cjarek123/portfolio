...
class FNNWithDropout:


    def __init__(self, init_shape: int, learning_rate: float = .0001, weight_decay: float = 0, dropout_prob = .3):
        self.learning_rate = learning_rate;
        self.weight_decay = weight_decay
        self.init_shape = init_shape
        self.model = self.init_model_(dropout_prob=.3)
    ...
    def predict_proba(self, input: Tensor):
        output = self.model(input)
        return output
    ...
    def init_model_(self, dropout_prob = .3): 
